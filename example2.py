...
# pyrpg
import srpge                # including but not limited to; subject to change
from srpge.core import *    # Game, Camera, Fader...
from srpge.scene import *   # Map2D, Tileset, Sprite, Mob, Player...
from srpge.ui import *      # TitleScreen, Dialogue, Selector, PlayerMenu...
