...
class Fader:
    def __init__(self, game):    
        self.game = game
        self.curtain = pygame.Surface(self.game.display.get_size())
    ...
    def update(self):    
        ...
        if self.fading:		
            ...
            self.opacity = utilities.clamp(self.opacity, 0, 255) # rename clamp; it keeps the number within a range
            self.curtain.set_alpha(self.opacity)
